...
exports.deserialize = exports.structured = exports.binary = void 0;
const __1 = require("../..");
...
function parseStructured(message, version) {
    ...
    if (eventObj.data && eventObj.datacontentencoding) {
        if (eventObj.datacontentencoding === __1.CONSTANTS.ENCODING_BASE64 && !validation_1.isBase64(eventObj.data)) {
            throw new validation_1.ValidationError("invalid payload");
        }
        else if (eventObj.datacontentencoding === __1.CONSTANTS.ENCODING_BASE64) {
