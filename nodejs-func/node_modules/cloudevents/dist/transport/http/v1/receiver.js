...
const passThrough = new parsers_1.PassThroughParser();
function parser(name, parser = passThrough) {
...
const binaryParsers = {
    ...
    [headers_1.BINARY_HEADERS.TIME]: parser("time", new parsers_1.DateParser()),
...
structuredParsers.set("time", parser("time", new parsers_1.DateParser()));
